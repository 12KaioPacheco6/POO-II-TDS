...
public class FXMLAnchorPaneCadastroMarcaController implements Initializable {
    ...
    @FXML
    private Label lbMarcaCPF;

    @FXML
    private Label lbMarcaDataNascimento;

    @FXML
    private Label lbMarcaNome;

    @FXML
    private Label lbMarcaTelefone;

    @FXML
    private Label lbMarcaEndereco;
    
    @FXML
    private TableColumn<Marca, String> tableColumnMarcaCPF;
    ...
    public void carregarTableViewMarca() {
        ...
        tableColumnMarcaCPF.setCellValueFactory(new PropertyValueFactory<>("cpf"));
    ...
    public void selecionarItemTableViewMarcas(Marca marca) {
        if (marca != null) {
            ...
            lbMarcaCPF.setText(marca.getCpf());
            lbMarcaTelefone.setText(marca.getTelefone());
            lbMarcaEndereco.setText(marca.getEndereco());
            lbMarcaDataNascimento.setText(String.valueOf(
                    marca.getDataNascimento().format(DateTimeFormatter.ofPattern("dd/MM/yyyy"))));
        } else {
            lbMarcaId.setText(""); 
            lbMarcaNome.setText("");
            lbMarcaCPF.setText("");
            lbMarcaTelefone.setText("");
            lbMarcaEndereco.setText("");
            lbMarcaDataNascimento.setText("");
        }
