...
INSERT INTO motor(id_produto) (SELECT max(id) FROM produto);
...
UPDATE motor SET quantidade=10, qtd_minima=2, qtd_maxima=100, situacao='ATIVO' WHERE id_produto = 1;
UPDATE motor SET quantidade=5, qtd_minima=2, qtd_maxima=150, situacao='INATIVO' WHERE id_produto = 2;
UPDATE motor SET quantidade=100, qtd_minima=2, qtd_maxima=500, situacao='BLOQUEADO' WHERE id_produto = 3;
UPDATE motor SET quantidade=300, qtd_minima=50, qtd_maxima=1000, situacao='ATIVO' WHERE id_produto = 4;

/* POR SE TRATAR DE UMA RELAÇÃO 1:1, UMA TENTATIVA DE INSERÇÃO DE UM NOVO ESTOQUE PARA UM PRODUTO DARÁ ERRO */
/*INSERT INTO motor(id_produto, quantidade, qtd_minima, qtd_maxima, situacao) VALUES (1, 20, 2, 100, 'ATIVO');*/
/* A TENTATIVA DE INSERIR UM ESTOQUE SEM QUE O PRODUTO EXISTA TAMBÉM CAUSARÁ ERRO*/
/*INSERT INTO motor(id_produto, quantidade, qtd_minima, qtd_maxima, situacao) VALUES (4, 20, 2, 100, 'ATIVO');*/
